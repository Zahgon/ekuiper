...
func SafeRun(fn func() error) (err error) { _ = "STUB: not implemented"; return nil }
...
// 1 means the caller of DrainError

func MsgWithStack(msg string) string { _ = "STUB: not implemented"; return "" }
